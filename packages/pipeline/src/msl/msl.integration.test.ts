...
describe("MSLClient", () => {
  it(
    "getTeams fetches teams for a season",
    async () => {
  ...
  it(
    "getPlayers fetches players for a season",
    async () => {
      const program = Effect.gen(function* () {
        const msl = yield* MSLClient;
  ...
  it(
    "getGoalies fetches goalies for a season",
    async () => {
      const program = Effect.gen(function* () {
        const msl = yield* MSLClient;
  ...
  it(
    "getStandings fetches standings for a season",
    async () => {
      const program = Effect.gen(function* () {
        const msl = yield* MSLClient;
  ...
  it(
    "getSchedule fetches schedule for season 9567",
    async () => {
      const program = Effect.gen(function* () {
        const msl = yield* MSLClient;
