...
function getGraphCanvasPalette(): GraphCanvasPalette {
  ...
  const brandAccent = readOklchVariable("--brand-accent", "oklch(0.603432 0.234297 27.067937)");
...
function GraphPage() {
  ...
  useEffect(() => {
    ...
    for (const edge of visibleGraph.edges) {
      ...
      ctx.strokeStyle = edge.kind === "tag" ? palette.brandAccent : palette.borderStrong;
